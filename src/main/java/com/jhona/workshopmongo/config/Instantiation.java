...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, LocalDateTime.parse("2018-03-21T10:35:10"), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", maria);
		Post post2 = new Post(null, LocalDateTime.parse("2018-03-23T09:10:47"), "Bom dia", "Acordei feliz hoje!", maria);
